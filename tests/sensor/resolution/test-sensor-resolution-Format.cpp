...
//    static_assert( !hub::writable_v<hub::sensor::resolution::Format> );
//    static_assert( !hub::readable_v<hub::sensor::resolution::Format> );
...
//    auto format2_read = archive.get<hub::sensor::resolution::Format>();
