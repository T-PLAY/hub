...
set(PDI_SDK
    "<UNSET>"
    CACHE PATH "Path of PDI SDK dir on your system")
...
if(PDI_SDK STREQUAL "<UNSET>")
    message(
        FATAL_ERROR
            "You must set PDI_SDK path of PDI_140 (WIN) or piterm-1.0.4 (LINUX) folder in your system see : https://ftp.polhemus1.com/pub/Trackers/Patriot/Software/ https://ftp.polhemus1.com/pub/Software/PDI_4.4.1_Setup-SWD-PS08-08.exe or https://ftp.polhemus1.com/pub/Software/Linux/"
    )
endif()
...
find_package_handle_standard_args(pdi REQUIRED_VARS PDI_LIBRARY PDI_INCLUDE_DIR)

mark_as_advanced(PDI_FOUND PDI_LIBRARY PDI_INCLUDE_DIR)

if(PDI_FOUND)
    set_target_properties(pdi PROPERTIES INTERFACE_LINK_LIBRARIES ${PDI_LIBRARY}
