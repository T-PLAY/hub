...
ELSE(WIN32)
  ...
  ELSE(APPLE)
    ...
    FILE(GLOB OCTAVE_INCLUDE_USR_PATHS "/usr/include/octave-*/octave")
...
IF(WIN32)
  ...
  FIND_PACKAGE_HANDLE_STANDARD_ARGS(Octave DEFAULT_MSG OCTAVE_ROOT OCTAVE_EXECUTABLE OCTAVE_INCLUDE_DIR OCTAVE_OCTINTERP_LIBRARY OCTAVE_OCTAVE_LIBRARY)
ELSE(WIN32)
  ...
  FIND_PACKAGE_HANDLE_STANDARD_ARGS(Octave DEFAULT_MSG OCTAVE_EXECUTABLE OCTAVE_INCLUDE_DIR OCTAVE_OCTINTERP_LIBRARY OCTAVE_OCTAVE_LIBRARY)
ENDIF(WIN32)
