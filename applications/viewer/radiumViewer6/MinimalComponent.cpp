...
MinimalComponent::MinimalComponent(Ra::Engine::Scene::Entity* entity, Ra::Engine::RadiumEngine& e, Ra::Gui::Viewer& viewer)
...
void MinimalComponent::addProbe()
{
    ...
    // scan plane
    {
        ...
        auto& textureParameters = m_engine.getTextureManager()->addTexture(probe.m_textureName.c_str(), 512, 192, data);
