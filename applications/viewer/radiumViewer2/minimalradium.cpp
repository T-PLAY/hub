...
MinimalComponent::MinimalComponent( Ra::Engine::Scene::Entity* entity, MinimalApp* app ) :
    Ra::Engine::Scene::Component( "Minimal Component", entity ), m_app( app ) {}
...
void MinimalComponent::initialize() {
    ...
    // scan plane
    {
        ...
        auto& textureParameters =
            m_app->m_engine->getTextureManager()->addTexture( "myTexture", 512, 192, data );
...
MinimalSystem::MinimalSystem( MinimalApp* app ) : m_app( app ) {
#ifndef ONLY_POSE
    try {
