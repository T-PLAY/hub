...
MainWindow::MainWindow( QWidget* parent ) : QMainWindow( parent ), ui( new Ui::MainWindow ) {
    ...
    //        std::string filepath = PROJECT_DIR "data/records/2022-05-23_13-32-34 (carotide)/ULA-OP
    //        256.txt"; assert(std::filesystem::exists(filepath)); std::fstream file(filepath,
    ...
    //        m_streamView2D->setData((unsigned char*)acq.m_data, sensorSpec.m_acquisitionSize,
    //        sensorSpec.m_dims, sensorSpec.m_format); m_streamView2D->setData((unsigned
    //        char*)acq.getMeasures().at(0).m_data, sensorSpec.m_acquisitionSize, dims, format);
    ...
    //        widgetStreamView.setData((unsigned char*)acq.m_data, sensorSpec.m_acquisitionSize,
    //        sensorSpec.m_dims, sensorSpec.m_format);
