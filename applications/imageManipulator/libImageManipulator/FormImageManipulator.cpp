...
FormImageManipulator::FormImageManipulator( QWidget* parent ) :
    ...
    //        ui->widgetStreamView_2->setData((unsigned char*)acq.mData,
    //        inputStream.getAcquisitionSize(), inputStream.getDims(), inputStream.getFormat());
    ...
    //        ui->widgetStreamView->setData((unsigned char*)data, imgSize, { imgWidth, imgHeight },
    //        Stream::Format::Y8);
