...
//
//  VSS $Header: /PiDevTools11/Inc/PDIlatus.h 3     1/09/14 1:05p Suzanne $  
//
/////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////
...
public:
	...
	BOOL	GetRcpCloseRangeMode	( INT nReceptor, BOOL & bCRMode );			// Gets Receptor Close Range Mode ('@R' command ) Pat-W ONLY
	BOOL	SetRcpCloseRangeMode	( INT nReceptor, const BOOL & bCRMode );	// Sets Receptor Close Range Mode
	...
	BOOL	MarkerLaunchExt		( INT nReceptor, INT nMarker, ePiHemisphere eHem );	//Launch Marker - Extended Control (Pat-W only)
