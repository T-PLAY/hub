...
//
//  VSS $Header: /PiDevTools12/Inc/PDIg4defs.h 9     8/01/19 3:46p Suzanne $  
//
/////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////
...
public:
	...
	{
		mode = rv.mode; digIOmap = rv.digIOmap;
	}
	...
	VOID Reset() { mode = 0; digIOmap = PDIG4_BUTTON_PACK_MAP; }
