...
class BinaryPosition
{
  ...
  public:
    BinaryPosition( SingleDataBinaryResponse2_4_1& binaryPositionData ) {
        ...
        eulerOrientationAngle.azimuth   = binaryPositionData.eulerOrientationAngles.azimuth;
        eulerOrientationAngle.elevation = binaryPositionData.eulerOrientationAngles.elevation;
        eulerOrientationAngle.roll      = binaryPositionData.eulerOrientationAngles.roll;
    }

    Position getPosition() {
        return Position( cartesianCoordiante.x, cartesianCoordiante.y, cartesianCoordiante.z );
    }

    Orientation getOrientation() {
        return Orientation( eulerOrientationAngle.azimuth,
