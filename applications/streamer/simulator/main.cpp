...
//    float transformPtr[9] = { 0.0 };
    ...
    metaData["transform"] = transformPtr;
//    metaData["transform3"] = mat3;
    //    metaData["x"] = 0.0;
    //    metaData["y"] = 0.0;
    //    metaData["z"] = 0.0;
    metaData["mriFile"] = "AXT2_ligaments_uterosacres/D0010525.dcm";
    OutputStream outputScanStream("Simulator", Stream::Format::Y8, { width, height }, ClientSocket(), metaData);
    ...
    //    OutputStream outputPosStream("Simulator", inputPosStream.getFormat(), inputPosStream.getDims(), ClientSocket(), metaData);
