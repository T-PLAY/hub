...

{
    while ( true ) {
        try {
#ifdef DEPTH_STREAM
            OutputStream depthStream(
                "L500 Depth Sensor (Depth)", Stream::Format::Z16, { 640, 480 } );
#endif
            ...
            OutputStream infraredStream(
                "L500 Depth Sensor (Infrared)", Stream::Format::Y8, { 640, 480 } );
#endif
