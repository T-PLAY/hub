...
//        AcquisitionZone acq(glm::vec3(-20, 0, 0), glm::angleAxis(0.0f, glm::vec3(1, 0, 0)), 200, 200, 200);
//        AcquisitionZone acq(glm::vec3(-50, 0, 50), glm::quat(1.0, 0.0, 0.0, 0.0), 200, 200, 200);
...
//        AcquisitionZone acq(glm::vec3(-50, 1, 50), glm::angleAxis(glm::radians(20.0f), glm::vec3(0, 1, 0)), 200, 200, 200);
        AcquisitionZone acq(glm::vec3(0, 1, 0), quat, 200, 200, 200);
//        AcquisitionZone acq(glm::vec3(80, 100, 0), glm::angleAxis(-90.f, glm::vec3(0, 0, 1)), 200, 200, 200);
//    AcquisitionZone acq(glm::vec3(100, 100, 50), glm::angleAxis(0.f, glm::vec3(1, 0, 0)), 256, 256, 256);
    ...
    stbi_write_jpg("test.jpg", width, height, 1, (void*)bu.getCorrespondingUS(acq, width, height).data(), 90);
