...
//    std::cout << frameTimestamp << std::endl;
//    std::cout << sensorTimestamp << std::endl;
...
//    Frame depthFrame(width, height, Frame::Format::Z16);
//    Stream depthStream(width, height, Stream::Format::Z16, Device::LIDAR, Sensor::L500_DEPTH_SENSOR);
    Stream depthStream(width, height, Stream::Format::Z16);
//    depthStream.attach(hub);
...
//    depthStream << Acquisition(backendTimestamp, backendTimeOfArrival, depth.get_data());

//        const auto & size = depth.get_data_size();
//    }
