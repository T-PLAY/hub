...
//        auto size = 0;
//        int _[]   = { ( size = size + Ts::nByte() )... };
//        return size;
//    }
//    using Tuple = std::tuple<Ts...>;
//    //    static constexpr auto Size = sizeof...(Ts);
//    static constexpr auto nResolution = sizeof...( Ts );
...
//    //        auto size = 0;
//    //        int _[]   = { ( size = size + Ts::nResolution() )... };
//    //        return size;
//    //    }
//    //    static auto name() {
//    //        std::string str;
...
// template <class... Ts>
// std::ostream& operator<<( std::ostream& os, const FormatT<Ts...>& format) {
//     //    (os << resolutions) ...;
//     //    (os << ... << resolutions);
