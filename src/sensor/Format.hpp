...
//    Format(Format && format) = delete;
//     Format(const Format & format) = delete;
//     Format() = default;

//     Format() = delete;

//    constexpr Format(int _nByte, std::string_view _name, bool _interpolable)
//         : nByte(_nByte)
//         , name(_name)
//         , interpolable(_interpolable)
//     {
//     }


//     constexpr Format(Input & input)
////         : nByte(input.get<decltype(nByte)>())
////         , name(input.get<decltype(name)>())
////         , interpolable(input.get<decltype(interpolable)>())
//     {
//         input.read((unsigned char*)this, sizeof(Format));
////         memcpy(this, )
//     }

//    template <class NByte, class Name, class Interpolable>
//    constexpr Format(NByte && _nbyte, Name && _name, Interpolable && _interpolable)
//        : nByte(std::forward<Size_t>(_nbyte)),
//        name(std::forward<char*>(_name)),
//        interpolable(_interpolable)
//    {

//    }

//    static Format get(Input & input) {
