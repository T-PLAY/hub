...
// Stream::Stream(const std::string& sensorName, Format format, const std::vector<int>& dims, const
// std::string& ipv4, int port)
//{
//#ifdef DEBUG_MSG
//#endif
// }

// Stream::Stream(const std::string& sensorName, Format format, const std::vector<int>& dims,
// std::fstream& file)
//{
//#ifdef DEBUG_MSG
//#endif
...
// InputStream::InputStream(const std::string& sensorName, const std::string& syncSensorName, const
// std::string& ipv4, int port)
//{
//#ifdef DEBUG_MSG
//#endif
...
// OutputStream::OutputStream(const std::string& sensorName, Stream::Format format, const
// std::vector<int>& dims, const MetaData& metaData, const std::string& ipv4, int port)
//{

//}

// OutputStream::OutputStream(const std::string& sensorName, Format format, const std::vector<int>&
// dims, std::fstream& file)
//{
...
OutputStream::OutputStream( const std::string& sensorName,
    ...
    //        std::cout << "[OutputStream] metadata: " << val.type().name() << " " << name << " = '"
    //        << any::to_string(val) << "'" << std::endl;
    //    }
    mIOStream.write( metaData );
}

// OutputStream::OutputStream(const std::string &sensorName, Stream::Format format, const
// std::vector<int> &dims, FileIO &&ioStream)
//{
