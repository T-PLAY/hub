...
//    //    m_outputSensor =
//    //        std::make_unique<sensor::OutputSensor>( sensorSpec, OutputStreamClient( std::move(
//    //        sock ) ) );
...
//    m_thread = new std::thread( [this, sockPtr]() {
//        try {
//            io::StreamInterface::ClientMessage mess;
//            sockPtr->read( mess );
//            assert( mess == io::StreamInterface::ClientMessage::STREAM_VIEWER_CLIENT_CLOSED );
