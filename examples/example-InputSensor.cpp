...
//    const hub::Input & input4 = hub::input::InputStreamInterface("streamName", ipv4, port); // abstract class
    ...
    hub::sensor::InputSensor inputSensor6(hub::input::InputSyncStream<hub::input::InputStreamServer>("streamName", "streamName2", ipv4, port));
    hub::sensor::InputSensor inputSensor7(hub::input::InputSyncStream<hub::input::InputStreamMqtt>("streamName", "streamName2", ipv4, port));
